          ...
          <div className="text-center">
            ...
            <div className="mb-8">
              <img
                src="../../public/logo.png"
                alt="VIENTO Logo"
                className="w-48 h-48 mx-auto object-cover rounded-full border-4 border-orange-300 shadow-lg"
              />
            </div>
            ...
            <p className="text-xl md:text-2xl mb-8 text-gray-600 max-w-3xl mx-auto">
              Ride the style, smooth and wild — caps and hats for every mile.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Discover the perfect style for every moment. From classic baseball
              caps to trendy bucket hats.
            </p>
          </div>
      ...
      <section className="py-16 bg-gradient-to-r from-amber-100 to-orange-100 text-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg mb-8 text-gray-700 max-w-2xl mx-auto">
            Get the latest updates on new arrivals, exclusive deals, and style
            tips.
          </p>
